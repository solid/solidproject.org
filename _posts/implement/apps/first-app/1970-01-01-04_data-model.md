...
Given the `profile` [we fetched before]({{site.baseUrl}}/implement/apps/first-app/3-reading-data), we can find a reference to the public Type
...
permission to write [when they signed in]({{site.baseUrl}}/implement/apps/first-app/1-authentication).)
...
Next: [Writing data]({{site.baseUrl}}/implement/apps/first-app/5-writing-data)
