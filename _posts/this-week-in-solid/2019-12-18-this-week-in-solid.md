...
* [**Inrupt**](https://inrupt.com): January 2019 saw the first public release (v0.1.0) of the new Solid React SDK with a new emphasis on supporting React. [Read more](https://jmartin.inrupt.net/public/docs/year-in-review.html) on the SDK work. Also, in 2019 the data browser team at inrupt has supported the development of the Solid Data Browser by making it easier to develop the project itself via [mashlib-dev](https://github.com/inrupt/mashlib-dev). We've 
