...
If you have a new tool or library, or have suggested additions or changes for this page, please [submit a PR](https://github.com/solid/solidproject.org/tree/main/_posts/developers/apps/tools/2021-05-25_libraries.md) or [contact the solidproject.org team](mailto:contact@solidproject.org). 
