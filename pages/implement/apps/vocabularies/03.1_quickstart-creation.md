...
We already know that [is a](http://www.w3.org/1999/02/22-rdf-syntax-ns#type) is identified by the IRI [rdf:type](http://www.w3.org/1999/02/22-rdf-syntax-ns#type), and [property](???) is identified by [rdf:Property](http://www.w3.org/1999/02/22-rdf-syntax-ns#Property) so we can now go ahead and change that into:
...
obelisk:p001 rdf:type rdf:Property .
obelisk:p002 rdf:type rdf:Property .
obelisk:p003 rdf:type rdf:Property .
```
